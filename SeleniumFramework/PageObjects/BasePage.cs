    ...
    public class BasePage : DriverManager
    {
        ...
        public void Click(By locator, int timeOutSeconds = 10)
        {
            ...
            while (DateTime.Now < now.AddSeconds(timeOutSeconds))
            {
                try
                {
                    new WebDriverWait(DriverInstance, TimeSpan.FromSeconds(timeOutSeconds)).Until(ExpectedConditions.ElementToBeClickable(locator)).Click();
        ...
        public void SendKeys(By locator, string text, int timeOutSeconds = 10)
        {
            ...
            while (DateTime.Now < now.AddSeconds(timeOutSeconds))
            {
                try
                {
                    new WebDriverWait(DriverInstance, TimeSpan.FromSeconds(10)).Until(ExpectedConditions.ElementIsVisible(locator)).SendKeys(text);
        ...
        {
            return new WebDriverWait(DriverInstance, TimeSpan.FromSeconds(timeOutSeconds)).Until(waitCondition);
        }
