...
{
    public class CsvTestDataHandler : ITestData
    {
        /// <summary>
        ...
        public Dictionary<string, string> GetTestData()
        {
            ...
            {
                return csv.GetRecords<CsvTestData>().Where(d => d.TestName == TestContext.CurrentContext.Test.Name).ToDictionary(x => x.Property, y => y.Value);
            }
        }
    }
}